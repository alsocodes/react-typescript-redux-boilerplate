export const tableDummies = [
  ...
  [
    'Terminal madiun ngawi dolanan ku, ora bakalan aku ngelalekne',
    'Biyen aku duwe kenalan, anak e pak tukiran bakul pecel nang perapatan',
    '32',
  ],
  ['Tapi entah ada dimana hanya aku dapat mencarinya', 'Mahadewi ', '55'],
];
